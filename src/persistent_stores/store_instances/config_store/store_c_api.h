...
uint16_t get_auto_filament_load_length_mm();
uint16_t get_filament_unload_length_mm();
...
void set_probe_x_offset_mm(float value);
void set_probe_y_offset_mm(float value);
void set_auto_filament_load_length_mm(uint16_t value);
void set_filament_unload_length_mm(uint16_t value);
void set_enable_eeprom_save(bool value);
